...
public class MonotonePiecesTriangulationDialog
{
			...
			MonotonePiecesTriangulationAlgorithm algorithm)
	{
		...
		ScrollableView<MonotonePiecesTriangulationPanel> scrollableView = new ScrollableView<>(
				mptp);

		Settings<MonotonePiecesTriangulationPanel> settings = new Settings<>(
				mptp);
		...
		VisualizationPainter painter = new MonotonePiecesTriangulationPainter(
